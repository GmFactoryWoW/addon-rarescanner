...
RareScanner335_Locales.enUS = {
  ...
  ALERT_KILLED_RARES = "Receive alerts for already killed rares",
  ALERT_KILLED_RARES_TOOLTIP = "Keep showing alerts for rares already recorded as killed.",
...
RareScanner335_Locales.frFR = {
  ...
  ALERT_KILLED_RARES = "Recevoir les alertes des rares déjà tués",
  ALERT_KILLED_RARES_TOOLTIP = "Continue d\'afficher les alertes pour les rares déjà enregistrés comme tués.",
